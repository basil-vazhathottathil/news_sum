    ...
    <div className='p-4 bg-gray-300 h-100 w-150 shadow-md rounded-lg flex flex-col justify-between'>
      ...
      <div className='flex flex-col items-center'>
        ...
        <div className='flex space-x-30 justify-center'>
          <button  onClick={index--} className='w-24 px-4 py-2 bg-blue-500 text-white rounded'>Previous</button>
          <a href={link} className='text-blue-500 mb-4 block'>src article</a>
          <button  onClick={index++} className='w-24 px-4 py-2 bg-gray-500 text-white rounded'>Next</button>
        </div>
      </div>
    </div>
  );
